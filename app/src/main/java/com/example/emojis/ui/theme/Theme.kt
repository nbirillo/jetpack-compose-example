package com.example.emojis.ui.theme
...
private val LightColorPalette = EmojisAppColors(
    brand = Shadow5,
...
private val DarkColorPalette = EmojisAppColors(
    brand = Shadow1,
...
object EmojisAppTheme {
    val colors: EmojisAppColors
        @Composable
        get() = LocalEmojiAppColors.current
}

@Stable
class EmojisAppColors(
    ...
    fun update(other: EmojisAppColors) {
    ...
    fun copy(): EmojisAppColors = EmojisAppColors(
...
@Composable
fun ProvideEmojiAppColors(
    colors: EmojisAppColors,
    content: @Composable () -> Unit
) {
    ...
    CompositionLocalProvider(LocalEmojiAppColors provides colorPalette, content = content)
}

private val LocalEmojiAppColors = staticCompositionLocalOf<EmojisAppColors> {
    error("No EmojiAppColorPalette provided")
}
